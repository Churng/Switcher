<template>
    <section id="groupIntroduction">
        <div class="container">
          <el-backtop :bottom="60"></el-backtop>
            <div class="row groupInfo pt-5 pb-5 d-flex flex-column">
                ...
                <div class="row groupBody d-flex justify-content-center pt-3">
                    <div class="col-md-5 col-6 d-flex justify-content-center flex-column"><img src="/img/users/https___hk-removebg-preview.png" alt="mario" class="w-100"></div>
                    <div class="col-md-6 col-10">
                        <div class="pt-5 pb-5">
                            <p>Swicther 定位在提供給消費社會一個新生活提案：先用小錢體驗高單價娛樂，以免買錯浪費。更進一步的，想要達到資源共享，傳達物資需被充分愛惜與利用的價值，重建人們愛物惜物的簡單生活。</p>
                            <p>Swicther 平台共享經濟的靈感，是來自兩位玩家，因為 2020 宅經濟爆發，在家無聊想娛樂自己娛樂家人，但礙於荷包不太充裕，害怕高價位的遊戲片可能不適合自己。或是透過家中現成的Switch遊戲，增加額外的收入補貼家用，兩人於是在火箭隊合作開發此平台。</p>
                            <p>「Swicther」取名是「一起成為 Switch 人」的意思，鼓勵大家出租家中的閒置遊戲，在賺點小錢的同時，也讓遊戲得到更多利用 -- 進而達到共享經濟的原則，也形成另一種被動收入的新創模式。</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid mt-lg-5 pt-5 pb-5 groupTeam">
            ...
            <div class="row d-flex justify-content-lg-center justify-content-md-around">
        ...
        <div class="container mt-5 pt-5 pb-5">
            ...
            <div class="row d-flex flex-sm-column flex-lg-row justify-content-center align-items-md-center align-items-lg-start">
                <div class="col-md-6 mb-5">
                    <h4 class="text-center mb-4 font-weight-bold">- 前端 -</h4>
                    <div class="row front_side">
...
.circle{
    ...
    align-items: center;
    background-color: rgba(211,204,227,.8);
    cursor: pointer;
    &:hover{
