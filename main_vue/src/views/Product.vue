            ...
            <div class="row switcherProduct-columns">
                <div class="col-12 col-lg-8 pb-sm-4 pb-md-0">
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide switcherProduct-img mb-4" data-ride="carousel">
                        <ol class="carousel-indicators" v-for="(img, index) in product[0].Images" :key="index">
                            <li data-target="#carouselExampleIndicators" :data-slide-to="index" :class="index === 0 ? 'active':''"></li>
                        </ol>
                        <div class="carousel-inner">
                          <div :class="index === 0 ? 'carousel-item active':'carousel-item'" v-for="(img, index) in product[0].Images" :key="index">
                    ...
                    <div class="switcherProduct-proInfo mb-3">
                        ...
                        <div class="proInfo-content d-flex justify-content-between align-items-end">
                            ...
                            <div class="contentDate">
                                <p class="mb-0">上架起始日：<span>{{product[0].PublishDate}}</span></p>
                            </div>
                        </div>
                    </div>
                </div>
