        ...
        <div class="container mb-5" v-if="$root.getCarts.length">
            <div>
              <div class="switcherOrder-orderArea border border-secondary pt-3 pb-3 pl-3 pr-3">
                <h6><i class="mr-2"><font-awesome-icon icon="store"/></i>賣家帳號 : <span>{{$root.getCarts[0].Seller}}</span></h6>
                <div class="row switcherOrder-content d-flex align-items-center pb-3 border-bottom border-light mb-3"  v-for="(item, index) in $root.getCarts" :key="index">
